...
static unsigned int texture[2]; // Armazena as informações sobre as texturas
...
void display(){
    ...
    glBegin(GL_POLYGON);
        ...
        glTexCoord2f(1.0, 0.0); glVertex3f(Y, 0.0, Y);
        glTexCoord2f(1.0, 1.0); glVertex3f(Y, 0.0, -Y);
        glTexCoord2f(0.0, 1.0); glVertex3f(-Y, 0.0, -Y);
    glEnd();
